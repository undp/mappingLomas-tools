...
# Mapa de frecuencias del verdor de de las lomas de la provincia de Lima y análisis de la influencia de los factores físico-geográfico usando Google Earth Engine - Python 
